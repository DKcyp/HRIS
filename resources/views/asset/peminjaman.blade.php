                    ...
                    <div class="modal fade" id="editModal{{ $l->id }}" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
                        <form action="{{ route('asset.peminjaman.update', $l->id) }}" method="POST">@csrf @method('PUT')
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3"><label class="form-label">Status</label><select class="form-select" name="status"><option value="dipinjam" {{ $l->status=='dipinjam' ? 'selected' : '' }}>Dipinjam</option><option value="dikembalikan" {{ $l->status=='dikembalikan' ? 'selected' : '' }}>Dikembalikan</option></select></div>
                            </div>
