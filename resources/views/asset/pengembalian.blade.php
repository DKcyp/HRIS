                    ...
                    <div class="modal fade" id="editModal{{ $r->id }}" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
                        <form action="{{ route('asset.pengembalian.update', $r->id) }}" method="POST">@csrf @method('PUT')
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-3"><div class="col-md-6"><label class="form-label">Kondisi</label><select class="form-select" name="kondisi_kembali"><option value="baik" {{ $r->kondisi_kembali=='baik' ? 'selected' : '' }}>Baik</option><option value="rusak_ringan" {{ $r->kondisi_kembali=='rusak_ringan' ? 'selected' : '' }}>Rusak Ringan</option></select></div><div class="col-md-6"><label class="form-label">Status</label><select class="form-select" name="status"><option value="diterima" {{ $r->status=='diterima' ? 'selected' : '' }}>Diterima</option><option value="pending" {{ $r->status=='pending' ? 'selected' : '' }}>Pending</option></select></div></div>
