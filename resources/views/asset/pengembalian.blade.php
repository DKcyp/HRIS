        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    @empty<tr><td colspan="11" class="text-center py-5 text-muted"><i class="fas fa-undo-alt fa-3x mb-3 d-block"></i><p>Belum ada data pengembalian</p></td></tr>@endforelse
                </tbody>
            </table>
        </div>
    </div>
