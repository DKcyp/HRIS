        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <div class="modal fade" id="editModal{{ $c->id }}" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
                        <form action="{{ route('dokumen.kontrak.update', $c->id) }}" method="POST">@csrf @method('PUT')
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3"><label class="form-label">Jenis</label><select class="form-select" name="jenis"><option value="PKWT" @if($c->jenis=='PKWT')selected@endif>PKWT</option><option value="PKWTT" @if($c->jenis=='PKWTT')selected@endif>PKWTT</option></select></div>
                            </div>
                    ...
                    @empty<tr><td colspan="11" class="text-center py-5 text-muted"><i class="fas fa-file-contract fa-3x mb-3 d-block"></i><p>Belum ada data kontrak</p></td></tr>@endforelse
                </tbody>
            </table>
        </div>
    </div>
